...
def run_mloop():
    ...
    min_boundary = [0,0,0,0,0]#, 794,736] #[max(2547, 0) for pos in init_positions] #pos - MLOOP_RANGE
    max_boundary = [4090, 4090, 4090, 4090, 4090]#, 1194, 936] #[min(2847, 4095) for pos in init_positions]
